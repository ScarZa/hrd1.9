...
<div class="row">
          <div class="col-lg-12">
              <h1><img src='images/money.ico' width='75'><font color='blue'>  ข้อมูลประวัติการประเมิน/เงินเดือน </font></h1> 
            <ol class="breadcrumb alert-success">
              <li><a href="index.php"><i class="fa fa-home"></i> หน้าหลัก</a></li>
              <li class="active"><i class="fa fa-edit"></i> ข้อมูลประวัติการประเมิน/เงินเดือน</li>
            </ol>
          </div>
      </div>
<div class="row">
          <div class="col-lg-12">
              <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><img src='images/Lfolder.ico' width='25'> ตารางประวัติการประเมิน/เงินเดือน</h3>
                    </div>
                <div class="panel-body">
                    <form class="navbar-form navbar-right" name="frmSearch" role="search" method="post" action="pre_eval.php">
...
$_SESSION['txtKeyword'] = isset($_POST['txtKeyword'])?$_POST['txtKeyword']:'';
                    ...
                    แสดงคำที่ค้นหา : <?= isset($Search_word)?$Search_word:''?>
                        <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" class="divider" rules="rows" frame="below">
                            <tr align="center" bgcolor="#898888">
                                ...
                                <td align="center" width="10%"><b>เพิ่มประวัติการประเมิน</b></td>
                            </tr>
...
while($result=mysqli_fetch_assoc($qr)){?>
    <tr>
                                ...
                                <td><a href="detial_eval.php?id=<?=$result['empno'];?>"><?=$result['fullname'];?></a></td>
                                <td align="center"><?=$result['posname'];?></td>
                                <td align="center"><a href="#" onclick="return popup('add_eval.php?id=<?= $result['empno'] ?>', popup, 500, 750);">
