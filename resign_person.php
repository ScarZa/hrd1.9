...
while($result=mysqli_fetch_assoc($qr)){?>
    <tr>
                                ...
                                <td align="center" width="12%"><a href='resign_person.php?del_id=<?=$result['empno'];?>' onClick="return confirm('กรุณายืนยันการลบอีกครั้ง !!!')"><img src='images/bin1.png' width='30'></a></td>
        </tr>
    <?php $i++; } ?>
