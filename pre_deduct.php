...
<div class="row">
          <div class="col-lg-12">
              <h1><img src='images/money.ico' width='75'><font color='blue'>  ข้อมูลกองทุนสำรองเลี้ยงชีพ </font></h1> 
            <ol class="breadcrumb alert-success">
              <li><a href="index.php"><i class="fa fa-home"></i> หน้าหลัก</a></li>
              <li class="active"><i class="fa fa-edit"></i> ข้อมูลกองทุนสำรองเลี้ยงชีพ</li>
            </ol>
          </div>
      </div>
<div class="row">
          <div class="col-lg-12">
              <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><img src='images/Lfolder.ico' width='25'> ตารางกองทุนสำรองเลี้ยงชีพ</h3>
                    </div>
                <div class="panel-body">
                    <form class="navbar-form navbar-right" name="frmSearch" role="search" method="post" action="pre_deduct.php">
...
while($result=mysqli_fetch_assoc($qr)){?>
    <tr>
                                ...
                                <td><a href="detial_deduct.php?id=<?=$result['empno'];?>"><?=$result['fullname'];?></a></td>
                                <td align="center"><?=$result['posname'];?></td>
                                <td align="center"><a href="#" onclick="return popup('add_deduct.php?id=<?= $result['empno'] ?>', popup, 500, 600);">
