...
if ($_SESSION['Status']=='USER' or $_SESSION['Status']=='SUSER'  or $_SESSION['Status']=='USUSER') {
    ...
    $detial = mysqli_query($db,"SELECT *,e7.statusname as emp_status,e6.statusname as wstatus,
...
where e1.empno='$empno' GROUP BY e1.empno order by e5.educate desc");
    ...
    $tophis=mysqli_query($db,"SELECT wh.his_id, wh.empcode, wh.dateBegin, po.posname, d1.depName, et.StucName, etp.TypeName, ed.eduname, d2.dep_name,
...
WHERE em.empno='$empno' order by ed2.educate desc");
    ...
    $Tophis = mysqli_fetch_assoc($tophis);
