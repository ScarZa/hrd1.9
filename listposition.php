...
if(isset($_POST['method'])?$_POST['method']:''=='search_position'){
...
while($result=mysqli_fetch_assoc($qr)){?>  
				    ...
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href='./prcposition.php?method=delete&dep_id=<?=$result['posId']?>'  title="confirm" onclick="if(confirm('ยืนยันการลบออกจากรายการ !!!')) return true; else return false;">   
