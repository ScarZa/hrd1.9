...
//คำสั่งค้นหา
         ...
         order by idpi desc";
                        ...
                        $q = "SELECT * from trainingin where dateBegin BETWEEN '$y-10-01' and '$Yy-09-30' order by idpi desc";
                    }
                } else {
...
//คำสั่งค้นหา
         ...
         order by idpi desc";
                        ...
                        $q = "SELECT * from trainingin where dateBegin BETWEEN '$Y-10-01' and '$y-09-30' order by idpi desc";
                    }
                } else {
                    $date01 = $_SESSION['check_date01'];
                    $date02 = $_SESSION['check_date02'];
...
//คำสั่งค้นหา
                ...
                <table align="center" width="100%" border="1">
                    <?php if (isset($_SESSION['check_trainin'])?$_SESSION['check_trainin']:'' == 'check_trainin') { ?>
                        <tr>
...
<?php } ?>
                    <tr align="center" bgcolor="#898888">
                        ...
                        <td width="6%" align="center"><b>เลขที่</b></td>
