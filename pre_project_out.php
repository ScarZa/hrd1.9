...
if (!empty($_REQUEST['del_id'])) { //ถ้า ค่า del_id ไม่เท่ากับค่าว่างเปล่า
    ...
    mysqli_query($db,$event_del) or die(mysqli_error($db));
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php if($_SESSION['Status']=='ADMIN' and $method!='back'){?>
...
$project_id = $_REQUEST['id'];
$sql_pro = mysqli_query($db,"SELECT t.*, CONCAT(e.firstname,' ',e.lastname) as fullname,p.PROVINCE_NAME 
FROM training_out t
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <?php
                            if(empty($_GET['empno'])){
                                $sql_pro_name = mysqli_query($db,"SELECT *, CONCAT(e.firstname,' ',e.lastname) as fullname 
                                    FROM plan_out p
