...
$method = isset($_POST['method'])?$_POST['method']:'';
 if($method=='search_name'){
  ...
  if(isset($Search_fname) || isset($Search_lname)){
...
while($result=mysqli_fetch_assoc($qr)){?>  
					...
					<a href='./prcuser.php?method=delete&user_id=<?=$result['empno']?>&ID=<?= $result['ID']?>'  title="confirm" onclick="return confirm('ยืนยันการลบ!!!! ')">   
