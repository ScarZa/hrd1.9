        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
               ...
               <div class="form-group">
                ...
                <div class="col-lg-12">
                    <textarea class="form-control" type="text" name="massege" id="massege" placeholder="ข้อความที่ต้องการให้แสดง" rows="6"><?= isset($event['event_title'])?$event['event_title']:''?></textarea>
                </div></div> 
                ...
                <div class="form-group">  
                    <?php if(isset($event['process'])?$event['process']:''=='4'){ $select1='selected';$select2='';}
                      elseif(isset($event['process'])?$event['process']:''=='5'){$select1='';$select2='selected';}?>
