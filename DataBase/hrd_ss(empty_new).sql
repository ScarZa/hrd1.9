/*
 ...
 Source Schema         : hrd_test

 Target Server Type    : MySQL
 Target Server Version : 100113
 File Encoding         : 65001

 Date: 17/11/2017 16:19:19
*/
...
) ENGINE = MyISAM AUTO_INCREMENT = 999 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `cancle`  (
  ...
  `cancledate` datetime(0) NOT NULL,
...
CREATE TABLE `cneu`  (
  ...
  `cneu` int(3) NOT NULL,
  PRIMARY KEY (`cneu_id`) USING BTREE
...
CREATE TABLE `comment`  (
  ...
  `comm` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `comm_date` datetime(0) NOT NULL,
  `check_comm` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `count`  (
  ...
  `count_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `count` VALUES (5, 'regis_projectout', 0000);
INSERT INTO `count` VALUES (6, 'regis_projectin', 0000);
...
) ENGINE = MyISAM AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 8861 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `educate`  (
  ...
  `educate` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `major` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `institute` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `emppersonal` VALUES (1, '0001', '0123456789876', '1', 'ผู้ดูแล', 'ระบบบุคลากร', '1', '2016-10-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0001', '02', '4', '1', '042808121', '0890277607', 'scarza@hotmail.com', '28', '5', '39', '', '2016-10-03', '0000-00-00', '', NULL);
INSERT INTO `emppersonal` VALUES (2, '0002', '0123456789875', '1', 'ผู้ใช้งานทั่วไป', 'ระบบบุคลากร', '1', '2016-10-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0002', '02', '4', '1', '042808101', '', '', '28', '4', '7', '', '2016-10-03', '0000-00-00', '', NULL);
INSERT INTO `emppersonal` VALUES (3, '0003', '0123456789874', '1', 'พนักงาน', 'ขับรถ', '1', '2016-09-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '1', '0003', '02', '4', '1', '042808102', '', '', '23', '4', '40', '', '2016-09-01', '0000-00-00', '', NULL);
INSERT INTO `emppersonal` VALUES (4, '0004', '0123456789873', '1', 'เจ้าหน้าที่', 'โสต', '1', '2016-08-01', '440 ม.4 ต.นาอาน', '', '4000', '446', '30', '42000', '2', '0004', '02', '3', '1', '042808103', '', '', '18', '5', '13', '', '2016-08-01', '0000-00-00', '', NULL);
...
CREATE TABLE `empstuc`  (
  ...
  PRIMARY KEY (`Emstuc`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `emptype`  (
  ...
  PRIMARY KEY (`EmpType`) USING BTREE
...
CREATE TABLE `fingerprint`  (
  ...
  `work_scan` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `finish_work_scan` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `register` int(7) NOT NULL,
  `see` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `reason_forget` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `hospital`  (
  ...
  `name2` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `late`  (
  ...
  `register` int(7) NOT NULL,
  `see` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `reason_late` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `explain_date` date DEFAULT NULL,
  `exponent` int(7) DEFAULT NULL,
  `explanation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `exp_status` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `late` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `editer` int(7) DEFAULT NULL,
  `editdate` date DEFAULT NULL,
...
CREATE TABLE `leave_day`  (
  ...
  `fiscal_year` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `member`  (
  ...
  `time_login` time(0) DEFAULT NULL,
...
CREATE TABLE `month`  (
  ...
  `month_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `month_short` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `plan_out`  (
  ...
  `pj_obj` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  ...
  `book` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `paper` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `cd` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `OPI` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
) ENGINE = MyISAM AUTO_INCREMENT = 273 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `print_tleave`  (
  ...
  PRIMARY KEY (`printt_id`) USING BTREE
...
CREATE TABLE `re_comment`  (
  ...
  `recomm` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `recomm_date` datetime(0) NOT NULL,
  `check_recomm` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`recomm_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `regularity`  (
  ...
  `topic_regu` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `regu_file` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `regu_date` datetime(0) NOT NULL,
  `empno_regu` int(1) NOT NULL,
  PRIMARY KEY (`regu_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `se_borrow_order`  (
  ...
  `bo_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `bo_status` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `se_material`  (
  ...
  `mate_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mate_unit` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mate_type_id` int(7) NOT NULL,
  `receive` int(7) NOT NULL,
  `pay` int(7) NOT NULL,
  `min` int(2) NOT NULL,
  `max` int(4) NOT NULL,
  PRIMARY KEY (`mate_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Compact;
...
CREATE TABLE `se_material_type`  (
  ...
  PRIMARY KEY (`mate_type_id`) USING BTREE
...
CREATE TABLE `se_pay`  (
  ...
  `empno` int(7) NOT NULL,
  `pay_status` enum('B','W') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'W',
...
CREATE TABLE `se_pay_borrow`  (
  ...
  `empno` int(7) NOT NULL,
  PRIMARY KEY (`pbo_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Compact;
...
CREATE TABLE `se_pay_order`  (
  ...
  `empno` int(7) NOT NULL,
  `dep_id` int(2) NOT NULL,
  `or_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `or_status` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ss_car`  (
  ...
  `car_no` varchar(9) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `wait` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `license_plate` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `pay` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `payer` int(7) DEFAULT NULL,
  `paye_date` date DEFAULT NULL,
  `approve` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ss_car_status`  (
  ...
  `carstatus_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`carstatus_id`) USING BTREE
...
CREATE TABLE `ss_car_type`  (
  ...
  `cartype_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `ss_carlicense`  (
  ...
  `license_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `ss_member`  (
  ...
  PRIMARY KEY (`ss_UserID`) USING BTREE
...
CREATE TABLE `tbl_event`  (
  ...
  `event_title` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `event_start` datetime(0) NOT NULL,
  `event_end` datetime(0) NOT NULL,
  `event_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `event_allDay` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `empno` int(5) NOT NULL,
  `workid` int(7) NOT NULL,
  `typela` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `timela`  (
  ...
  `idno` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `vstdate` date NOT NULL,
  `comment` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `datela` date NOT NULL,
  `starttime` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `endtime` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `total` double NOT NULL,
  `status` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `idAdmin` int(4) DEFAULT NULL,
  `pics_t` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `depId` int(7) NOT NULL,
  `regis_time` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `topic_post`  (
  ...
  `photo_post` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `link` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `empno_status` enum('ADMIN','USER') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `training_out`  (
  ...
  `Hos_car` varchar(2) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
