...
INSERT INTO `amphur` (`AMPHUR_ID`, `AMPHUR_CODE`, `AMPHUR_NAME`, `name_en`, `PROVINCE_ID`) VALUES
...
INSERT INTO `district` (`DISTRICT_CODE`, `zip_code`, `DISTRICT_NAME`, `name_en`, `AMPHUR_ID`) VALUES
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='InnoDB free: 8192 kB';

--
-- Dumping data for table `geographies`
--

INSERT INTO `geographie` (`id`, `name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
INSERT INTO `province` (`PROVINCE_ID`, `PROVINCE_CODE`, `PROVINCE_NAME`, `name_en`, `GEO_ID`) VALUES
