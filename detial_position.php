...
ORDER BY p.posname desc;"); ?>
                        ...
                        <table id="datatable" width="100%" border="0" cellspacing="0" cellpadding="0" class="divider" rules="rows" frame="below">
                          ...
                          <?php
                          $person[0]= isset($person[0])?$person[0]+$detial_type['bureaucrat']:'';
                          $person[1]= isset($person[1])?$person[1]+ $detial_type['permanent_emp']:'';
                          $person[2]= isset($person[2])?$person[2]+ $detial_type['government_emp']:'';
                          $person[3]= isset($person[3])?$person[3]+ $detial_type['pgs']:'';
                          $person[4]= isset($person[4])?$person[4]+ $detial_type['month_emp']:'';
                          $person[5]= isset($person[5])?$person[5]+ $detial_type['day_emp']:'';
                          $person[6]= isset($person[6])?$person[6]+ $detial_type['total']:'';
                          $i++; }?>
                          <tr>
                              <th colspan="2">รวม</th>
