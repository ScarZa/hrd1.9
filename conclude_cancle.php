...
$detial = mysqli_query($db,"select concat(p1.pname,e1.firstname,' ',e1.lastname) as fullname,e1.empno as empno,w.*,c.*,t1.*
                            from emppersonal e1 
...
while ($result = mysqli_fetch_assoc($detial)) {
    ?>
                                <tr>
                                    ...
                                    <?php
                                        $namE=  mysqli_query($db,"select e.firstname as name from emppersonal e 
                                    ...
                                    <td align="center">
                                        <?php if (!empty($result['pics_cancle'])) {
