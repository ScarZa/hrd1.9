...
<div class="row">  
              ...
              <div class="panel panel-danger">
                <div class="panel-heading">
                  ...
                  <div class="form-group">
                      ...
                      <textarea class="form-control" name="regu" required="" cols="50" rows="5" placeholder="กรุณาใส่หัวข้อระเบียบ/ข้อบังคับ ที่ต้องการประกาศ"><?= isset($regu['topic_regu'])?$regu['topic_regu']:''?></textarea>
                  </div>
                      <div class="form-group">
    ...
    <div class="col-lg-6">
<?php include_once 'total_regularity.php';?>
    </div></div></div>
