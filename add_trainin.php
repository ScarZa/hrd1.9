        ...
        <tr>
            <td>
                <div class="form-group">
                    <input type="text" placeholder="ค้นหา ชื่อ/ตำแหน่ง/หน่วยงาน" name='txtKeyword' class="form-control" value="" >
...
function page_navigator($before_p,$plus_p,$total,$total_p,$chk_page){   
 ...
 if(isset($_POST['method'])?$_POST['method']:''=='txtKeyword'){
$_SESSION['txtKeyword']=$_POST['txtKeyword'];
 }
$Search_word= isset($_SESSION['txtKeyword'])?$_SESSION['txtKeyword']:'';
 if(!empty($Search_word)){
//คำสั่งค้นหา
     $q="select e1.empno as empno, e1.pid as pid, concat(p2.pname,e1.firstname,'  ',e1.lastname) as fullname, p1.posname as posname, d.depName as dep
         from emppersonal e1 
...
INNER JOIN department d on d.depId=wh.depid
         WHERE wh.posid=p1.posId and (e1.firstname LIKE '%$Search_word%' or d.depName LIKE '%$Search_word%' or p1.posname LIKE '%$Search_word%')
...
?>
 <?php $project=  mysqli_query($db,"select * from trainingin where idpi='$trainin_id'");
