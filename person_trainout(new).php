...
$sql_per = mysqli_query($db,"select concat(p1.pname,e1.firstname,' ',e1.lastname) as fullname,d1.depName as dep,p2.posname as posi,e1.empno as empno
    ...
    $sql_pro = mysqli_query($db,"SELECT t.*, p.PROVINCE_NAME,t2.tName as tname,po.join_type 
FROM training_out t 
...
<form class="navbar-form navbar-left" role="form" action='prctraining.php' enctype="multipart/form-data" method='post' onSubmit="return Check_txt()">
 ...
 <div class="form-group"> 
                ...
                <input value='<?= isset($person_data['complacency'])?$person_data['complacency']:''?>' NAME="complacency" id="complacency"  class="form-control" placeholder="ร้อยละของความพึงพอใจ">
 </div><br>
    <?php }?>
 <div class="form-group"> 
 ...
 <br>
 <b>เอกสารประกอบ : </b>
 <?php if(isset($person_data['paper'])?$person_data['paper']:''=='มี'){?>
 ...
 <br>
 <b>CD ข้อมูล : </b>
  <?php if(isset($person_data['cd'])?$person_data['cd']:''=='มี'){?>
