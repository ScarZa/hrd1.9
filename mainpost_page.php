...
if(empty($_REQUEST['edit_id']) and empty($_REQUEST['del_id'])){
$empno=$_SESSION['user'];
              ...
              <div class="panel panel-success">
                <div class="panel-heading">
                  ...
                  <div class="form-group">
                      ข้อความ 
                      <textarea class="form-control" name="post" required="" cols="50" rows="5" placeholder="กรุณาใส่ข้อความที่ต้องการประชาสัมพันธ์"><?= isset($post)?$post:''?></textarea>
                  </div><br><br>
                  <div class="form-group">
                          Link
                          <input type="text" name="link" id="link" size="50" class="form-control" value="<?= isset($link)?$link:''?>" placeholder="https://sample.com">
                      </div><br><br>
                      <div class="form-group">
